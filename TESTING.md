...
| Email verification | Click verification link in confirmation email | Account verified and user can log in | ✅ Works | ![screenshot](documentation/manual-testing/email-verification.png) |
| Login (valid) | Log in with correct username/email and password | User is authenticated and redirected to home page | ✅ Works | ![screenshot](documentation/manual-testing/login-valid.png) |
| Login (invalid) | Attempt login with incorrect password | Error message shown and login denied | ✅ Works | ![screenshot](documentation/manual-testing/login-invalid.png) |
| Logout | Click logout while logged in | User is logged out and redirected; restricted pages no longer accessible | ✅ Works | ![screenshot](documentation/manual-testing/logout.png) |
| Brute-force URL testing | Visit restricted pages without being logged in | User redirected to login page | ✅ Works | ![screenshot](documentation/manual-testing/brute-force1.png)<br>![screenshot](documentation/manual-testing/brute-force2.png) |
| Browse products | View all products on the products page | All products display with images, names and prices | ✅ Works | ![screenshot](documentation/manual-testing/products.png) |
| Product detail | Click on a product to view its detail page | Product detail page loads with description, price, size selector and quantity input | ✅ Works | ![screenshot](documentation/manual-testing/product-detail.png) |
| Add to cart | Add a product to the cart | Product appears in cart with correct quantity and price | ✅ Works | ![screenshot](documentation/manual-testing/add-to-cart.png) |
| Update cart quantity | Increase/decrease quantity in cart | Total updates correctly | ✅ Works | ![screenshot](documentation/manual-testing/update-cart.png) |
| Remove from cart | Click remove on a cart item | Item is removed and totals update | ✅ Works | ![screenshot](documentation/manual-testing/remove-from-cart.png) |
| Empty cart message | View cart with no items | Friendly message displayed with link to shop | ✅ Works | ![screenshot](documentation/manual-testing/empty-cart.png) |
| Stripe checkout (valid) | Complete checkout with test card `4242 4242 4242 4242` | Order created, confirmation email sent, redirected to success page | ✅ Works | ![screenshot](documentation/manual-testing/checkout-success.png) |
| Stripe checkout (invalid card) | Enter invalid card details | Error message displayed and order not created | ✅ Works | ![screenshot](documentation/manual-testing/checkout-invalid.png) |
| Order confirmation email | Complete a purchase | Confirmation email received with order details | ✅ Works | ![screenshot](documentation/manual-testing/order-email.png) |
| Order history | View profile after purchase | Order appears in order history with correct details | ✅ Works | ![screenshot](documentation/manual-testing/order-history.png) |
| View class timetable | Navigate to class schedule | All classes display with instructor, date, time and capacity | ✅ Works | ![screenshot](documentation/manual-testing/timetable.png) |
| Book a class | Click book on an available class | Booking confirmed, success toast displayed | ✅ Works | ![screenshot](documentation/manual-testing/book-class.png) |
| Cancel a class | Cancel an existing booking | Booking removed, capacity updated | ✅ Works | ![screenshot](documentation/manual-testing/cancel-class.png) |
...
| View subscription plans | Navigate to subscriptions page | All three plans display with prices and descriptions | ✅ Works | ![screenshot](documentation/manual-testing/subscription-plans.png) |
| Subscribe to a plan | Select a plan and complete Stripe checkout | Subscription activated, confirmation email sent | ✅ Works | ![screenshot](documentation/manual-testing/subscribe.png) |
| Duplicate subscription (defensive) | Attempt to subscribe while already subscribed | Error message displayed, prevented from subscribing to second plan | ✅ Works | ![screenshot](documentation/manual-testing/duplicate-subscription.png) |
| Cancel subscription | Click cancel subscription on profile | Subscription cancels at end of billing period, status updated | ✅ Works | ![screenshot](documentation/manual-testing/cancel-subscription.png) |
| Subscription confirmation email | Subscribe to a plan | Confirmation email received with subscription details | ✅ Works | ![screenshot](documentation/manual-testing/subscription-email.png) |
| Add product (superuser) | Add a new product via admin | Product appears in catalogue | ✅ Works | ![screenshot](documentation/manual-testing/add-product.png) |
| Edit product (superuser) | Edit an existing product | Changes saved and displayed correctly | ✅ Works | ![screenshot](documentation/manual-testing/edit-product.png) |
| Delete product (superuser) | Delete a product with confirmation prompt | Product removed from catalogue | ✅ Works | ![screenshot](documentation/manual-testing/delete-product.png) |
| Non-superuser product management (defensive) | Attempt to access edit/delete product URLs as regular user | Access denied, user redirected | ✅ Works | ![screenshot](documentation/manual-testing/product-defensive.png) |
| Newsletter signup | Submit email via newsletter form | Success message displayed, email saved to database | ✅ Works | ![screenshot](documentation/manual-testing/newsletter.png) |
| Job application | Submit job application form with CV upload | Success page displayed, application saved to database | ✅ Works | ![screenshot](documentation/manual-testing/job-application.png) |
| Toast notifications | Trigger various actions (add to cart, book class, etc.) | Appropriate toast message displayed for each action | ✅ Works | ![screenshot](documentation/manual-testing/toast.png) |
| Navigation (burger icon) | Resize screen and click burger icon on mobile | Navbar collapses on small screens and expands correctly | ✅ Works | ![screenshot](documentation/manual-testing/navbar-toggle.png)<br>![screenshot](documentation/manual-testing/navbar-expand.png) |
| Navbar conditional links | Compare navbar logged out vs logged in | Correct links shown/hidden based on auth state | ✅ Works | ![screenshot](documentation/manual-testing/navbar-logged-out.png)<br>![screenshot](documentation/manual-testing/navbar-logged-in.png) |
