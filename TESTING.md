...
| Cart | ![screenshot](documentation/testing/responsiveness/mobile-cart1.PNG) <br> ![screenshot](documentation/testing/responsiveness/mobile-cart2.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-cart.png) | ![screenshot](documentation/responsiveness/laptop/cart.png) | ![screenshot](documentation/responsiveness/desktop/cart.png) |
| Checkout | ![screenshot](documentation/testing/responsiveness/mobile-checkout1.PNG) <br> ![screenshot](documentation/testing/responsiveness/mobile-checkout2.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-checkout1.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-checkout3.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-checkout3.png) | ![screenshot](documentation/responsiveness/laptop/checkout.png) | ![screenshot](documentation/responsiveness/desktop/checkout.png) |
...
| Profile | ![screenshot](documentation/testing/responsiveness/mobile-profile1.PNG) <br> ![screenshot](documentation/testing/responsiveness/mobile-profile2.PNG) <br> ![screenshot](documentation/testing/responsiveness/mobile-profile3.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-profile1.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-profile2.png)| ![screenshot](documentation/responsiveness/laptop/profile.png) | ![screenshot](documentation/responsiveness/desktop/profile.png) |
|Nutrition|![screenshot](documentation/testing/responsiveness/mobile-nutrition.PNG)|![screenshot](documentation/testing/responsiveness/tablet-nutrition.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-nutrition2.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-nutrition3.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-nutrition4.png)|![screenshot](documentation/testing/responsiveness/laptop-nutrition21.png) <br> ![screenshot](documentation/testing/responsiveness/laptop-nutrition2.png)|![screenshot](desktop)|
