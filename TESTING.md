...
| --- | --- | --- | --- | --- |
| Home | ![screenshot](documentation/testing/responsiveness/mobile-home.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-home1.png) <br>  ![screenshot](documentation/testing/responsiveness/tablet-home2.png) | ![screenshot](documentation/testing/responsiveness/laptop-home1.png) <br> ![screenshot](documentation/testing/responsiveness/laptop-home2.png) | ![screenshot](documentation/responsiveness/desktop/home.png) |
| Products | **General user**![screenshot](documentation/testing/responsiveness/mobile-products.png) <br> **Super user** ![screenshot](documentation/testing/responsiveness/mobile-products-superuser.PNG) | **General user**![screenshot](documentation/testing/responsiveness/tablet-products1.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-products2.png)<br> **Super user**![screenshot](documentation/testing/responsiveness/tablet-products-superurer.png)| **General user**![screenshot](documentation/testing/responsiveness/laptop-products.png) <br> **Super user**![screenshot](documentation/testing/responsiveness/laptop-products-superuser.png)| ![screenshot](documentation/responsiveness/desktop/products.png) |
| Product Details | ![screenshot](documentation/testing/responsiveness/mobile-product-details.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-product-details1.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-product-details2.png) | ![screenshot](documentation/testing/responsiveness/laptop-product-details.png) | ![screenshot](documentation/responsiveness/desktop/product-detail.png) |
| Cart | ![screenshot](documentation/testing/responsiveness/mobile-cart1.PNG) <br> ![screenshot](documentation/testing/responsiveness/mobile-cart2.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-cart.png) | ![screenshot](documentation/testing/responsiveness/laptop-cart.png) | ![screenshot](documentation/responsiveness/desktop/cart.png) |
| Checkout | ![screenshot](documentation/testing/responsiveness/mobile-checkout1.PNG) <br> ![screenshot](documentation/testing/responsiveness/mobile-checkout2.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-checkout1.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-checkout3.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-checkout3.png) | ![screenshot](documentation/testing/responsiveness/laptop-checkout1.png) <br> ![screenshot](documentation/testing/responsiveness/laptop-checkout2.png) | ![screenshot](documentation/responsiveness/desktop/checkout.png) |
| Class Timetable | ![screenshot](documentation/testing/responsiveness/mobile-classes.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-classes.png) | ![screenshot](documentation/testing/responsiveness/laptop-classes.png) | ![screenshot](documentation/responsiveness/desktop/timetable.png) |
| Subscription Plans | ![screenshot](documentation/testing/responsiveness/mobile-subscriptions.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-subscriptions.png) | ![screenshot](documentation/testing/responsiveness/laptop-subscriptions.png) | ![screenshot](documentation/responsiveness/desktop/subscriptions.png) |
| Profile | ![screenshot](documentation/testing/responsiveness/mobile-profile1.PNG) <br> ![screenshot](documentation/testing/responsiveness/mobile-profile2.PNG) <br> ![screenshot](documentation/testing/responsiveness/mobile-profile3.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-profile1.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-profile2.png)| ![screenshot](documentation/testing/responsiveness/laptop-profile.png) | ![screenshot](documentation/responsiveness/desktop/profile.png) |
|Nutrition|![screenshot](documentation/testing/responsiveness/mobile-nutrition.PNG)|![screenshot](documentation/testing/responsiveness/tablet-nutrition.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-nutrition2.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-nutrition3.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-nutrition4.png)|![screenshot](documentation/testing/responsiveness/laptop-nutrition.png) <br> ![screenshot](documentation/testing/responsiveness/laptop-nutrition2.png)|![screenshot](desktop)|
| Login | ![screenshot](documentation/testing/responsiveness/mobile-login.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-login.png) | ![screenshot](documentation/testing/responsiveness/laptop-login.png) | ![screenshot](documentation/responsiveness/desktop/login.png) |
| Sign Up | ![screenshot](documentation/testing/responsiveness/mobile-create-account.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-create1.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-create2.png) | ![screenshot](documentation/testing/responsiveness/laptop-signup.png) | ![screenshot](documentation/responsiveness/desktop/signup.png) |
| 404 | ![screenshot](documentation/testing/responsiveness/mobile-404.png) | ![screenshot](documentation/testing/responsiveness/tablet-404.png) | ![screenshot](documentation/testing/responsiveness/laptop-404.png) | ![screenshot](documentation/responsiveness/desktop/404.png) |
