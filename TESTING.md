...
| Duplicate booking (defensive) | Attempt to book the same class twice | Warning message displayed, duplicate booking prevented | ✅ Works | ![screenshot](documentation/testing/features/test-f-double-booking-defence.png) |
| Full class (defensive) | Attempt to book a class at capacity | Error message displayed, booking prevented | ✅ Works | ![screenshot](documentation/testing/features/test-f-fullybooked.png) |
...
| --- | --- | --- | --- | --- |
| Home | ![screenshot](documentation/testing/responsiveness/mobile-home.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-home1.png) <br>  ![screenshot](documentation/testing/responsiveness/tablet-home2.png) | ![screenshot](documentation/testing/responsiveness/laptop-home1.png) <br> ![screenshot](documentation/testing/responsiveness/laptop-home2.png) | ![screenshot](documentation/testing/responsiveness/desktop-home1.png) <br> ![screenshot](documentation/testing/responsiveness/desktop-home2.png) |
| Products | **General user**![screenshot](documentation/testing/responsiveness/mobile-products.png) <br> **Super user** ![screenshot](documentation/testing/responsiveness/mobile-products-superuser.PNG) | **General user**![screenshot](documentation/testing/responsiveness/tablet-products1.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-products2.png)<br> **Super user**![screenshot](documentation/testing/responsiveness/tablet-products-superurer.png)| **General user**![screenshot](documentation/testing/responsiveness/laptop-products.png) <br> **Super user**![screenshot](documentation/testing/responsiveness/laptop-products-superuser.png)| **General user**![screenshot](documentation/testing/responsiveness/desktop-products.png) <br>  **Super user**![screenshot](documentation/testing/responsiveness/desktop-products-superuser.png) |
| Product Details | ![screenshot](documentation/testing/responsiveness/mobile-product-details.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-product-details1.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-product-details2.png) | ![screenshot](documentation/testing/responsiveness/laptop-product-details.png) | ![screenshot](documentation/testing/responsiveness/desktop-product-details.png) |
| Cart | ![screenshot](documentation/testing/responsiveness/mobile-cart1.PNG) <br> ![screenshot](documentation/testing/responsiveness/mobile-cart2.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-cart.png) | ![screenshot](documentation/testing/responsiveness/laptop-cart.png) | ![screenshot](documentation/testing/responsiveness/desktop-cart.png) |
| Checkout | ![screenshot](documentation/testing/responsiveness/mobile-checkout1.PNG) <br> ![screenshot](documentation/testing/responsiveness/mobile-checkout2.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-checkout1.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-checkout3.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-checkout3.png) | ![screenshot](documentation/testing/responsiveness/laptop-checkout1.png) <br> ![screenshot](documentation/testing/responsiveness/laptop-checkout2.png) | ![screenshot](documentation/testing/responsiveness/desktop-checkout1.png) <br> ![screenshot](documentation/testing/responsiveness/desktop-checkout2.png) |
| Class Timetable | ![screenshot](documentation/testing/responsiveness/mobile-classes.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-classes.png) | ![screenshot](documentation/testing/responsiveness/laptop-classes.png) | ![screenshot](documentation/testing/responsiveness/desktop-classes.png) |
| Subscription Plans | ![screenshot](documentation/testing/responsiveness/mobile-subscriptions.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-subscriptions.png) | ![screenshot](documentation/testing/responsiveness/laptop-subscriptions.png) | ![screenshot](documentation/testing/responsiveness/desktop-subscriptions.png) |
| Profile | ![screenshot](documentation/testing/responsiveness/mobile-profile1.PNG) <br> ![screenshot](documentation/testing/responsiveness/mobile-profile2.PNG) <br> ![screenshot](documentation/testing/responsiveness/mobile-profile3.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-profile1.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-profile2.png)| ![screenshot](documentation/testing/responsiveness/laptop-profile.png) | ![screenshot](documentation/testing/responsiveness/desktop-profile.png) |
|Nutrition|![screenshot](documentation/testing/responsiveness/mobile-nutrition.PNG)|![screenshot](documentation/testing/responsiveness/tablet-nutrition.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-nutrition2.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-nutrition3.png) <br> ![screenshot](documentation/testing/responsiveness/tablet-nutrition4.png)|![screenshot](documentation/testing/responsiveness/laptop-nutrition1.png) <br> ![screenshot](documentation/testing/responsiveness/laptop-nutrition2.png)|![screenshot](documentation/testing/responsiveness/desktop-nutrition1.png) <br> ![screenshot](documentation/testing/responsiveness/desktop-nutrition2.png)|
| Login | ![screenshot](documentation/testing/responsiveness/mobile-login.PNG) | ![screenshot](documentation/testing/responsiveness/tablet-login.png) | ![screenshot](documentation/testing/responsiveness/laptop-login.png) | ![screenshot](documentation/testing/responsiveness/desktop-login.png) |
