...
class SubscriptionPlan(models.Model):
    ...
    # Predefined choices allowing the user
    # to select a specific subscription plan
    PLAN_CHOICES = [
    ...
    # The below fields are from ChatGPT to
    # help imporve the users experience and
    # make the app more sophisticated.
